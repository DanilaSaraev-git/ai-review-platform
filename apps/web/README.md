...
Рабочее место построено вокруг исходного документа и панели разбора. На desktop
они остаются рядом; на узком экране складываются по вертикали без горизонтальной
прокрутки страницы. Контекст запуска, ограничения, источники и параметры
