...
## Phase 17: Исторический этап Kimi — инцидент 2026-09-06

Этап предшествовал подключению Яндекса. При объединении веток его прежние номера
T038, T039 и T040 заменены на T042, T043 и T044 соответственно; номера текущего
этапа Яндекса и диагностики сохранены. Это изменение нумерации не объявляет
исторические генерации заново разрешёнными.
