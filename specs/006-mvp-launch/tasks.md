...
- [ ] T043 Сохранять фиксированную безопасную причину semantic validation, исправить terminal state и трактовку retryable в UI; проверить на synthetic fixtures и выпустить без генераций.
- [ ] T044 После отдельного разрешения на один диагностический запрос установить конкретную причину отказа реального ответа и проверить необходимое исправление. Исходный raw response не сохранён, поэтому offline replay этого запуска невозможен.
