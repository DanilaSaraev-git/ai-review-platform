...
- [ ] T037 Устранить обнаруженный серверным preflight конфликт legacy/canonical digest у review-data-spec 1.0.0: выпустить пакет 1.0.1, проверить переход unconfigured→ML→unconfigured с сохранением прежней записи; повторить promotion до T034–T035.
