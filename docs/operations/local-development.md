...
Локальный набор содержит `yandex-gpt-oss-20b` 1.0.2, `yandex-qwen3.6-35b` 1.0.1 и
`yandex-deepseek-v4-flash` 1.0.0; первым и самым дешёвым вариантом выбран GPT-OSS 20B.
