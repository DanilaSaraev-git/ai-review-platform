...
`efe06f13c6f0c52d164b1c34df5e6fd81bc238f8`, предыдущий —
`8913a73e2ff7beef407e6b745d1d84216625a600`. Актуальный release определяется ссылкой
...
Текущий release сохраняет безопасную причину будущих semantic отказов в `error.message`,
не записывая текст документа или ответа. [Настройки Яндекса](configuration.md#deepseek-через-yandex-ai-studio)
...
Откат приложения на предыдущий `8913a73e2ff7beef407e6b745d1d84216625a600`
сохраняет действующий профиль Яндекса. Только для более ранних версий без Yandex auth
