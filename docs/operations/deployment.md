...
Откат приложения на установленный commit. Для текущего Yandex-выпуска сначала выполните
описанный ниже возврат к прежней модели:
...
Перед откатом текущего Yandex-выпуска на `33d94299150259a853bf47566fb77c59655ac4b8`
