...
Продуктовые гипотезы, интервью, материалы заказчиков и результаты клиентских экспериментов хранятся отдельно в `ai-review-product`(https://github.com/DanilaSaraev-git/ai-review-product). В этот репозиторий разрешены только синтетические fixtures.
...
Последний продовый выпуск — `30573ab`: асинхронный запуск, восстановление ответов
и сохранение замечаний при неверных ссылках. [Проверки и выкладка 7 сентября](docs/operations/deployment.md#объединение-последних-исправлений--2026-09-07).
