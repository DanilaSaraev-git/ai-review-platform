...
ReviewRuntime = LLMReviewRuntime | LLMReviewRouter


@dataclass(frozen=True, slots=True)
class GuestContext:
    platform: PostgresReviewPlatform
    runtime: ReviewRuntime | None
...
class GuestContextRegistry:
    ...
    async def _serve_until_idle(self, entry: _Entry, runtime: ReviewRuntime | None) -> None:
        while True:
            async with self._lock:
    ...
    @staticmethod
    async def _notify_when_idle(runtime: ReviewRuntime, changed: anyio.Event) -> None:
